...
object Problem3 {
  def main(args: Array[String]): Unit = {
    ...
    println(s"VERTICES: $verticesCount")
    println(s"EDGES: $edgesCount")
    ...
    //Degree-distribution
    val degrees: VertexRDD[Int] = pokemonGraph.degrees.cache()
    ...
    val maxTriangleGraph = pokemonGraph.degrees.mapValues(d => d * (d - 1) / 2.0)
